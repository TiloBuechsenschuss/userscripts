...
Fallen London:
  ...
  Implemented (grouped as above; the Airs storylets are those an existing feature badges):
    ...
    Airs of London storylets (no guide):
      ...
      - https://fallenlondon.wiki/wiki/The_Honey-Dens_of_Veilgarden [6 unlock] (in choice-helper)
      - https://fallenlondon.wiki/wiki/Intervene_in_a_Dockers%27_Brawl [3 unlock, 2 text] (in choice-helper)
      - https://fallenlondon.wiki/wiki/Working_for_the_Widow [5 unlock] (in choice-helper)
      - https://fallenlondon.wiki/wiki/Business_on_Watchmaker%27s_Hill [4 unlock] (in choice-helper)
      - https://fallenlondon.wiki/wiki/Life_on_Ladybones_Road [4 unlock] (in choice-helper)
...
Kingdom of Loathing:
  - filter box items that can be used to get other items — the "pays out"
    checkbox on inventory.php, ux-enhancers 1.21. Verified in-game: filtering,
    packing, using an item while filtered, and unticking all behave.
